...
public class Data {
    ...
    /**
    * Highest/Maximal Chou-Fasman (CF) coefficient.
    */
    private double maxCF;

    /**
    * Highest/Maximal conformation coefficient (CC).
    */
    ...
    */
    public Data(){
        ...
        this.maxCF = -1;
        this.maxCC = -1;
        this.mode = SimConfig.TRAIN_MODE_NORMAL;
    }
    ...
    */
    ...
    /**
    * Loads data from data file in following format:
    * aaSeq1
    * sspSeq1
    * psipredSeq1
    * reliabIndexesSeq1
