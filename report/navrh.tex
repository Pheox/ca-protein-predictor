...
% zakladny model (z clanku Chopry), modifikacie modelu (nove ideje)

Navrhnutý systém z~veµkej èasti vychádza z~2~prác venujúcich
sa SSP pomocou CA \cite{chopra_2007} \cite{salanda_2012}.
Modifikované sú tie èasti systému, ktoré majú potenciál zlep¹i»
úspe¹nos» predikcie SSP. Ide hlavne o~spôsob klasifikácie
jednotlivých reziduí popísaný ni¾¹ie.
