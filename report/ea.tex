...
v horách Walesu. Koncom roka 1831 v¹ak odi¹iel na 5-roè\-nú výskumnú cestu okolo sveta.
...
publikovanom v roku 1859 s názvom {\it O vzniku druhov prírodným výberom alebo uchovávanie prospe¹ných plemien v boji o ¾ivot}.
Vrhá ucelený pohµad na vývoj druhov oslobodený od spirituality
a nábo¾enských predstáv svojej a predchádzajúcich dôb a hlavou plnou
prírodovedných informácii získaných z okru¾nej plavby okolo sveta.
Darwin vysvetµuje vznik rôznych druhov organizmov
na základe prirodzeného výberu, teda schopnosti pre¾i» len tých najschopnej¹ích.
% citacia darwina?
...
hrajú významnú úlohu vo fonde vedomostí µudstva.
...
o genetických algoritmoch, v práci publikovanej v roku 1989 \cite{goldberg_ga_89}.
...
evoluèných algoritmov. Pre ujasnenie pojmov ponúkam ich krátky prehµad.

Medzi základné pojmy Darwinovej evoluèn¹j teórie patrí populácia.
Populácia je mno¾ina jedincov, ka¾dý je reprezentovaný svojím genetickým materiálom.
V~tejto práci budem voµne zamieòa» pojmy genetický materiál, genóm a~chromozóm,
aj keï z~pohµadu biológie tieto pojmy nie sú rovnocenné.
Vlastné zakódovanie genetickej informácie do~urèitej ¹truktúry oznaèujeme ako genotyp.
...
teda odli¹né prostredia spôsobili odli¹nú interpretáciu genotypu na~fenotyp.
Genetický materiál resp. genóm sa skladá z~lineárne usporiadaných génov,
...
Existujú problémy, ktorých presný model sa nedá, nevieme alebo je veµmi
nároèné zostavi» a~navy¹e, stavový priestor resp. mno¾ina rie¹ení
daného problému je obrovská.
...
Softcomputing rie¹i problémy pomocou nejakej heuristiky resp. heuristickej funkcie, ktorou
algoritmus \uvoz{myslí}. Potrebné je doda», ¾e metódy softcomputingu èastokrát nedávajú
najlep¹ie rie¹enie, ale len suboptimálne, ktoré nám v¹ak èastokrát postaèuje.
